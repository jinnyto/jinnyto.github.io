...
layout: post
title: 'Wind'
image: assets/images/test-post_landscape-2.png
tags:
  - theme
  - documentation
---
...
A Minimalistic, Simple, and Beautiful Blogging Theme
...
- `base.html` &mdash; The base layout that lays the foundation for subsequent layouts. The derived layouts inject their
  contents into this file at the line that says `some text here` and are linked to this file via
